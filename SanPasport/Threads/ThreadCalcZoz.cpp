#include "ThreadCalcZoz.h"

void ThreadCalcZoz::run()
{
...
void ThreadCalcZoz::loadTask(QVector<Task> vecTasks, QVector<Antenna> vecAntennas)
{
    this->tasks = vecTasks;
    this->antennas = vecAntennas;
    this->stop = false;
}


void ThreadCalcZoz::stopCalc()
{
    stop = true;
}
