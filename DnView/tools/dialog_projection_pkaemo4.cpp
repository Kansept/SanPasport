#include "dialog_projection_pkaemo4.h"
#include "ui_dialog_projection_pkaemo4.h"
...
Dialog_projection_PKAEMO4::Dialog_projection_PKAEMO4(QWidget *parent) :
    QDialog_projection_PKAEMO4(parent),
    ui(new Ui::Dialog_projection_PKAEMO4)
{
    ui->setupUi(this);
...
Dialog_projection_PKAEMO4::~Dialog_projection_PKAEMO4()
{
    delete ui;
}
// Выбор файлов
bool Dialog_projection_PKAEMO4::openFiles()
{
...
// Выбор папки
bool Dialog_projection_PKAEMO4::setPath() {
...
// ------------------------------------------------Загрузка файла
void Dialog_projection_PKAEMO4::loadFiles(QStringList qslFiles) {
...
QByteArray Dialog_projection_PKAEMO4::strMaxItem(QByteArray qbaSrez, QByteArray qbaRead) {
...
bool Dialog_projection_PKAEMO4::unionFiles() {
